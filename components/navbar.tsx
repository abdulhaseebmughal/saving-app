...
import { FileText, Code, Settings, Clipboard, Menu, X, FolderKanban, Upload, LogOut, Download, User, Package, GraduationCap } from "lucide-react"
...
export function Navbar() {
  ...
  const links = [
    { href: "/", label: "Dashboard", icon: Clipboard },
